...
sub_system1 = load_fmu("TempControl.fmu")
...
sub_system2.set('Tin',np.float64(300.0))
sub_system2.set('constantVoltage.V',np.float64(50.0))

sub_system1.set("port",6006)
sub_system1.set("outputPath","TempControl")
